...
(function ($) {
  ...
  Calendar.SHORT_DAY_NAMES = ['Вс', 'Пн', 'Вт', 'Ср', 'Чт', 'Пт', 'Сб']
  ...
  Calendar.MONTH_NAMES_IN_GENITIVE_CASE = [
  ...
  Calendar.prototype = {
    ...
    create: function (parent) {
      ...
      // Calendar Navigation
      row = $('<tr />')
      this._drawButtonCell(row, '&#x00ab', 1, Calendar.NAV_PREVIOUS_YEAR)
      this._drawButtonCell(row, '&#x2039', 1, Calendar.NAV_PREVIOUS_MONTH)
      this._drawButtonCell(row, Calendar.TODAY, 3, Calendar.NAV_TODAY)
      this._drawButtonCell(row, '&#x203a', 1, Calendar.NAV_NEXT_MONTH)
      this._drawButtonCell(row, '&#x00bb', 1, Calendar.NAV_NEXT_YEAR)
      thead.append(row)
    ...
    showAtElement: function (element) {
      ...
      this.showAt(offset.left - offsetMain.left, offset.top - offsetMain.top + scrollTop)
    },
